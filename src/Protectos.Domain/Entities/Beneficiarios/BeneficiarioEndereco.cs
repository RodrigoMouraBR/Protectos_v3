...
{
    public class BeneficiarioEndereco : Entity<BeneficiarioEndereco>
    {
        public BeneficiarioEndereco(string logradouro, string numero, string bairro, string cep, string complemento, string cidade, string estado, string uF, string pais, Guid beneficiarioId)
        {

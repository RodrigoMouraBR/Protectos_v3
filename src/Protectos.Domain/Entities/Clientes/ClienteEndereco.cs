...
{
    public class ClienteEndereco : Entity<ClienteEndereco>
    {
        public ClienteEndereco(string logradouro, string numero, string bairro, string cep, string complemento, string cidade, string estado, string uF, string pais, Guid clienteId)
        {

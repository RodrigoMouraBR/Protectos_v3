...
namespace Protectos.Domain.Entities.Corretoras
{
    ...
    {
        public CorretoraEndereco(string logradouro, string numero, string bairro, string cep, string complemento, string cidade, string estado, string uF, string pais, Guid corretoraId)
        {
